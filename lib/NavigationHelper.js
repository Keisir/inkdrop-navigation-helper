...
module.exports = {
    config: {
        navigationHistory: {
            ...
            description: 'If this function is activated, a component is displayed in the sidebar with which you can navigate backwards and forwards in the history of the notes you have visited. (This plugin must be reloaded to apply this setting)',
            type: 'boolean',
            default: true
        },
        bringToNotebook: {
            title: 'Bring to notebook',
            description: 'If this feature is activated, a button is displayed above the editor that you can use to quickly navigate to the notebook of the current note. (This plugin must be reloaded to apply this setting)',
            type: 'boolean',
            default: true
        }
    },
