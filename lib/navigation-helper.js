...
var NavigationHelperPlugin = /** @class */ (function () {
    function NavigationHelperPlugin() {
        var _this = this;
        this.activate = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.deactivate = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    return NavigationHelperPlugin;
}());
var plugin = new NavigationHelperPlugin();
module.exports = {
    config: {
        navigationComponent: {
